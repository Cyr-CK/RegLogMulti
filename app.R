...
source("R/FAMD_.R")
source("R/one_hot_encoder.R")
source("R/standard_scaler.R")
source("R/min_max_scaler.R")
source("R/robust_scaler.R")
source("R/simple_quanti_imputer.R")
source("R/simple_quali_imputer.R")
